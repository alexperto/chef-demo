...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "alexperto2-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/penlab"
  #   chef.validation_client_name = "penlab-validator"
  #   chef.validation_key_path = ".chef/penlab-validator.pem"
  # end
end
